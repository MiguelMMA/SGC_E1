...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PacienteMedicoComponent = /** @class */ (function () {
                ...
                PacienteMedicoComponent.prototype.logIn = function (dniP, dniM) {
                    var ajustes = {
                        secure: true
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PedircitaComponent = /** @class */ (function () {
                ...
                PedircitaComponent.prototype.obtenerespecialidades = function () {
                    var _this = this;
                    return this.citaService.getAllEspecialidades().subscribe(function (response) {
                        _this.especialidades = response;
                        console.log(_this.especialidades);
                        console.log(_this.especialidades[0]._nombre);
                    });
                };
                PedircitaComponent.prototype.obtenerMedicosEspecialidad = function () {
                    var _this = this;
                    console.log(this.especialidadElegida);
                    return this.citaService.getMedicosEspecialidad(this.especialidadElegida).subscribe(function (response) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CitaService = /** @class */ (function () {
               ...
               */
                ...
                CitaService.prototype.getAllEspecialidades = function () {
                    this.tipo_data = '/especialidades';
                    return this.httpClient.get(this.URL_ENDPOINT + this.tipo_data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
                };
                CitaService.prototype.getMedicosEspecialidad = function (nombreEspecialidad) {
